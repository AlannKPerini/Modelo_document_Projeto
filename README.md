# Documentação do Projeto Integrador ou SA (Situação de Aprendizagem)- Modelo
*(Coloque aqui o nome do seu projeto.)*

Modelo de documentação para o desenvolvimento do Projeto Integrador do Curso de Técnico em Desenvolvimento de Sistemas -- FIESC SENAI - Joinville 
...
- [Aluno3](github.com/aluno2)
- [Aluno4](github.com/aluno2)
  
Links do projeto:
(*Coloque aqui os links para a documentação do projeto e os repositórios e plubicação do backend e frontend.*)
-   [Documentação (esse documento)](github.com/AlannKPerini/Modelo_document_Projeto)

**Como usar esse modelo para o Projeto Integrador ou SA (Situação de Aprendizagem)**
...
-   **Qual o foco de ação do software** relacionado com os problemas levantados na análise da situação-problema. O que realmente o software vai fazer. Quais as ações que você considera importante para resolver as necessidades do cliente.
...
**R.F. 01 - Nome do requisito funcional:** é o nome da função que o software terá. Sugerimos, por padronização, que tenha o prefixo R.F. (requisito funcional) seguida da numeração, para melhor identificação do requisito, acrescido do formato *“Substantivo + onde será feita a ação”*.
Por exemplo: 
- R.F. 01 - Registro de Funcionários 
- R.F. 02 - Gerenciamento de consultas 
- R.F. 03 - Débito em conta corrente 
...
**5.4.5 Exemplo de organização dos requisitos funcionais**
...
**5.4.6 Exemplo de requisito funcional**
...
**5.4.7 Organização dos requisitos funcionais**
...
**Exemplo de um Sistema de Padaria**:
...
**Exemplo de um Sistema de Ordem de Serviço:**
